...
filename = "/content/drive/MyDrive/Colab_Notebooks/DRIVE_Augmented.rar"
...
train_data ='/content/DRIVE_Augmented/DRIVE_BioNet-Augmented/train' #data path
valid_data = '/content/DRIVE_Augmented/DRIVE_BioNet-Augmented/test'
...
checkpoint = ModelCheckpoint('/content/drive/MyDrive/Colab_Folder/Model Weights/DRIVE/checkpoints/MTLTransfuseep300bs16head4_32.h5', verbose=1, save_best_only=True,save_weights_only=True)
callbacks = [checkpoint]

results = model.fit(
    X_train,
    [y1_train_BV, y2_train_od],
    batch_size=batch_size,
    epochs=nb_epoch,
    callbacks=callbacks,
    validation_data=(X_test, [y1_test_BV, y2_test_od])
)
...
model.save_weights('/content/drive/MyDrive/Colab_Folder/Model Weights/DRIVE/checkpoints/MTLTransfuseep300bs16head4_32.h5')
...
test_image = load_img('/content/drive/MyDrive/Colab_Notebooks/DRIVE_Augmented/DRIVE_BioNet-Augmented/test/images/1.png', target_size=(512, 512))
